							...
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-3">
										...
										<a href="<c:url value='/admin/insertCategory'/>"
											class="btn btn-success text-right"><i class="fa fa-plush"></i>Thêm
											mới</a>
									</div>
									<div class="col-md-8 text-right">
										<form action="getTourByName" method="get" class="form-inline">
											...
											<button type="submit" class="btn btn-primary">
												<i class="fa fa-search"></i>Tìm kiêm
											</button>
										</form>
									</div>
								</div>
									...
									<tbody>
										<c:forEach items="${list}" var="tour">
											<tr>
												...
												<td>${tour.price}</td>
												<td>${tour.capacity}</td>
												<td>${tour.status ? 'Hiện' : 'Ẩn'}</td>
												<td><img alt=""
													src="/Spring01/resources/img/${tour.image}" width="60px"></td>
												<td>${tour.category.name}</td>
												<td class="text-right"><a href="viewUpdate?id=${tour.tourId }"
													class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
													<a href="deleteProduct?id=${tour.tourId }"
