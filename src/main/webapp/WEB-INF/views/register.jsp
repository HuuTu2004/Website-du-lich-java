		...
		<div class="container text-center py-5" style="max-width: 900px;">
			<h3 class="text-white display-3 mb-4">
				...
				<ol class="breadcrumb justify-content-center mb-0">
					...
					<li class="breadcrumb-item active text-white">Đăng Kí Tài
						Khoản</li>
				</ol>
		</div>
	</div>
		...
		<div class="container py-5">
			<div class="row g-5 align-items-center">
				...
				<div class="col-lg-12">
					...
					<h1 class="text-white mb-3">Đăng Kí Tài Khoản</h1>
						...
						<div class="row g-3">
							...
							<div class="col-md-6">
								<div class="form-floating">
									<form:input path="fullName"
										class="form-control bg-white border-0" placeholder="Họ Và Tên" />
							...
							<div class="col-md-6">
								<div class="form-floating">
									<form:input path="passWord"
										class="form-control bg-white border-0" placeholder="Mật Khẩu" />
							...
							<div class="col-md-6">
								<div class="form-floating">
									...
									<label for="SelectPerson">Giới Tính</label>
								</div>
							</div>
							<div class="col-12">
								<div class="form-floating">
									<form:textarea path="address"
										class="form-control bg-white border-0"
										placeholder="Địa Chỉ Của Bạn" style="height: 100px" />
									<label for="message">Địa Chỉ Của Bạn</label>
