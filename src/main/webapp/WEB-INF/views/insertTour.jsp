				...
				<ul class="sidebar-menu">
					...
					<li class=" treeview"><a href="#"> <i class="fa fa-th"></i>
						...
						<ul class="treeview-menu">
							<li><a href="<c:url value='/admin/listCategory'/>"><i
									class="fa fa-circle-o"></i> Danh sách</a></li>
							<li class="active"><a
								href="<c:url value='/admin/insertCategory'/>"><i
									class="fa fa-circle-o"></i> Thêm mới</a></li>
						</ul></li>

					<li class="active treeview"><a href="#"> <i
							class="fa fa-th"></i> <span>Quản lý Tour</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="<c:url value='/admin/listProduct'/>"><i
									class="fa fa-circle-o"></i> Danh sách</a></li>
							<li class="active"><a
								href="<c:url value='/admin/insertProduct'/>"><i
									class="fa fa-circle-o"></i> Thêm mới</a></li>
						</ul></li>

<li class="treeview"><a href="#"> <i
							class="fa fa-th"></i> <span>Quản Lý Khách Hàng</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li class="active"><a
						...
						<ul class="treeview-menu">
							...
							<li><a href="<c:url value='/admin/listOrderNo'/>"><i
						...
						<div class="row">
							<div class="col-md-12">
								<div class="box-body">
									...
									<form:form action="insert-product" method="post" modelAttribute="t" enctype="multipart/form-data">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="tourName">Tên Gói Tour:</label>
													<form:input path="tourName" id="tourName" placeholder="Tour Name" cssClass="form-control" />
													<form:errors path="tourName" cssClass="text-danger" />
												</div>
												<div class="form-group">
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<form:input path="capacity" id="capacity"
														placeholder="Capacity" type="text" class="form-control" />
													<form:errors path="capacity" cssClass="text-danger" />
												</div>
												<div class="form-group">
													<label>Trạng Thái :</label> <br>

													<form:radiobutton path="status" id="statusActive"
														value="true" class="form-check-input" />
													Hiện

													<form:radiobutton path="status" id="statusInactive"
												...
												<div class="form-group">
													...
													<form:select path="category.id" id="category"
														...
														<form:options items="${cat}" itemLabel="name"
															itemValue="id" />
													</form:select>
