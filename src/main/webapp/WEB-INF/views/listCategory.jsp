			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview"><a href="#"> <i
							class="fa fa-th"></i> <span>Danh Mục</span> <i
					...
					<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<c:if test="${pram.uscc!=null}">
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert"
											aria-hidden="true">&times;</button>
										<strong>Alert!</strong> ${param.uscc }
									</div>
								</c:if>
									...
									<tbody>
										<c:forEach items="${list }" var="c">
											<tr>
												...
												<td>${c.description}</td>
												<td class="text-right"><a href="viewEdit?id=${c.id }"
													class="btn btn-primary"><i class="fa fa-edit"></i>Sửa</a> <a
													href="deleteCategory?id=${c.id }"
													class="btn btn-danger btndelete"><i class="fa fa-trash"></i>Xóa</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
