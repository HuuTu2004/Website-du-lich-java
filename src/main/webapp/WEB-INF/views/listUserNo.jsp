									...
									<tbody>
										<c:forEach items="${list}" var="user">
											<tr>
												...
												<form:form action="insertUserRole" modelAttribute="r">
													<td><form:select path="role.id">
															<form:options items="${listR }" itemLabel="name"
																itemValue="id" />
														</form:select></td>
													<td class="text-right"><form:hidden path="user.id"
															value="${user.id}" />
